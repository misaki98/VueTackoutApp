  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch"  :class="{on:TextOnly}" @click="TextOnly=!TextOnly">
...
export default {
  data() {
    return {
      TextOnly:true,
      selectType:2 //是否显示指定的评价类型0：满意，1：不满意，2：全部
    };
  },
  mounted() {
  ...
  computed: {
    ...
    filterRatings(){
      const {ratings,selectType,TextOnly} = this
      let newRatings = ratings
        // 产生一个过滤后的新数组
      return ratings.filter(rating=>{
        return (selectType===2||selectType===rating.rateType) && (!TextOnly||rating.text.length>0)
      })
    }
  },
  methods: {
